...
//__________________________________________________________________________
Double_t TrackParam::getP() const
{
  /// return p from track parameters
    Double_t px_ = getPx();
    Double_t py_ = getPy();
    Double_t pz_ = getPz();
    return TMath::Sqrt(px_*px_+py_*py_+pz_*pz_);

}

//__________________________________________________________________________
Double_t TrackParam::getPt() const
{
  /// return pt from track parameters
    Double_t px_ = getPx();
    Double_t py_ = getPy();
    Double_t pt_ = TMath::Sqrt(px_*px_+py_*py_);
    return pt_;
