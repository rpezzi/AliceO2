...
#ifndef ALICEO2_ENDCAPS_TOPOLOGYDICTIONARY_H
#define ALICEO2_ENDCAPS_TOPOLOGYDICTIONARY_H
...
class TopologyDictionary
{
 public:
  ...
  static constexpr int MaxNumberOfClasses = o2::itsmft::Cluster::kMaxPatternBits / MinimumClassArea; ///< Maximum number of row/column classes for the groups of rare topologies
  ...
  math_utils::Point3D<float> getClusterCoordinates(const o2::itsmft::CompCluster& cl) const;
  ///Returns the local position of a compact cluster
  static math_utils::Point3D<float> getClusterCoordinates(const o2::itsmft::CompCluster& cl, const ClusterPattern& patt);
...
#endif // ALICEO2_ENDCAPS_TOPOLOGYDICTIONARY_H
