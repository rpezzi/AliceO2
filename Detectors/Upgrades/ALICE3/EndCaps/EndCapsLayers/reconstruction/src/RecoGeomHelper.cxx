...
void RecoGeomHelper::RecoLadder::updateLimits(const Point3D<float>& pntGlo)
{
  ...
  o2::math_utils::BringTo02Pi(phiRange.min());
  o2::math_utils::BringTo02Pi(phiRange.max());
  phiRange.update(phi);
  ...
  o2::math_utils::BringToPMPi(phiRange.min()); // -pi:pi range
  o2::math_utils::BringToPMPi(phiRange.max());
...
void RecoGeomHelper::RecoLayer::init()
{
  ...
  gm->fillMatrixCache(o2::math_utils::bit2Mask(o2::TransformType::T2GRot, o2::TransformType::T2L)); // more matrices ?
